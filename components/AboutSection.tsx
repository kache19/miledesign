      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal-item">
            <h2 className="text-sm font-bold text-terracotta uppercase tracking-[0.3em] mb-3">Our Legacy</h2>
            <h3 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-8 leading-tight">
              Crafting environments that <span className="italic text-terracotta">inspire</span> human connection.
            </h3>
            ...
            <div className="grid grid-cols-2 gap-8 mt-12">
              ...
              <div>
                ...
                <div className="text-xs font-bold text-slate-500 uppercase tracking-widest">Projects Handovered</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative reveal-item">
            ...
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-skyblue/10 rounded-full blur-3xl -z-10"></div>
            <div className="absolute top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-slate-900 rounded-3xl p-8 flex flex-col justify-center shadow-2xl z-20 hidden md:flex">
              <div className="text-terracotta text-3xl mb-2 italic">Vision</div>
              <p className="text-skyblue/80 text-xs leading-relaxed uppercase tracking-widest font-bold">Sustainable. Functional. Aesthetic.</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-24">
          {[
            ...
            <div key={i} className="bg-white p-10 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
              <div className={`text-3xl mb-6 ${pillar.color} group-hover:scale-110 transition-transform`}>{pillar.icon}</div>
